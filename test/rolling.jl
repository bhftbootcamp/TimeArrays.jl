...
@testset verbose = true "" begin
    ...
    @testset "Case №2: Periodic window" begin
        ...
        @test isequal(
            ta_rolling(sum, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 3.0),
                TimeTick(DateTime(2024, 1, 5), 5.0),
        ...
        @test isequal(
            ta_rolling(mean, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 1.5),
                TimeTick(DateTime(2024, 1, 5), 2.5),
        ...
        @test isequal(
            ta_rolling(maximum, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 2.0),
                TimeTick(DateTime(2024, 1, 5), 3.0),
        ...
        @test isequal(
            ta_rolling(minimum, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 1.0),
                TimeTick(DateTime(2024, 1, 5), 2.0),
        ...
        @test isequal(
            ta_rolling(first, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 1.0),
                TimeTick(DateTime(2024, 1, 5), 2.0),
        ...
        @test isequal(
            ta_rolling(last, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 2.0),
                TimeTick(DateTime(2024, 1, 5), 3.0),
        ...
        @test isequal(
            ta_rolling(median, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 1.5),
                TimeTick(DateTime(2024, 1, 5), 2.5),
        ...
        @test isequal(
            ta_rolling(std, ta_for_window, Day(4); observations = 2),
            TimeArray([
                TimeTick(DateTime(2024, 1, 1), NaN),
                TimeTick(DateTime(2024, 1, 2), 0.7071067811865476),
                TimeTick(DateTime(2024, 1, 5), 0.7071067811865476),
    ...
    @testset "Case №5: WMA" begin
        ...
        ta_after_wma_3d = TimeArray{DateTime,Float64}([
            TimeTick(DateTime(2024, 01, 1), NaN),
            TimeTick(DateTime(2024, 01, 2), NaN),
            TimeTick(DateTime(2024, 01, 3), 11.333333333333332),
            TimeTick(DateTime(2024, 01, 4), 12.333333333333332),
            TimeTick(DateTime(2024, 01, 5), 13.333333333333332),
            TimeTick(DateTime(2024, 01, 6), 14.333333333333332),
            TimeTick(DateTime(2024, 01, 7), 15.333333333333332),
            TimeTick(DateTime(2024, 01, 8), 16.333333333333332),
            TimeTick(DateTime(2024, 01, 9), 17.333333333333332),
            TimeTick(DateTime(2024, 01, 10), 18.333333333333332),
        ])

        @test isequal(ta_wma(ta, Day(3)), ta_after_wma_3d)

        ta_after_wma_7d = TimeArray{DateTime,Float64}([
            TimeTick(DateTime(2024, 01, 1), NaN),
            TimeTick(DateTime(2024, 01, 2), NaN),
            TimeTick(DateTime(2024, 01, 3), NaN),
            TimeTick(DateTime(2024, 01, 4), NaN),
            TimeTick(DateTime(2024, 01, 5), NaN),
            TimeTick(DateTime(2024, 01, 6), NaN),
            TimeTick(DateTime(2024, 01, 7), 14.0),
            TimeTick(DateTime(2024, 01, 8), 15.0),
            TimeTick(DateTime(2024, 01, 9), 16.0),
            TimeTick(DateTime(2024, 01, 10), 17.0),
        ])

        @test isequal(ta_wma(ta, Day(7)), ta_after_wma_7d)
    end
